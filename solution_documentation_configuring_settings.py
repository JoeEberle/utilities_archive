...
def get_credits(): 
    ...
    solution_credits = solution_credits + '\nThe solution was developed in Python starting on 11/03/2022'
...
def get_solution_notes():
    ...
    solution_notes = '\n \n'   # Start with a new line to separate documentation and make it more readable. 
    solution_notes = solution_notes + 'Some additional notes for this solution are: \n'
    solution_notes = solution_notes + 'Note 1: By default the configuration file name is config.ini and is located in the current working directory.\n'  
    ...
    solution_notes = solution_notes + 'Note 4: The global_infrastructure section of the configuration file can be overwritten with individual solution settings... however it is the individual developers responsibility to overwrite global settings and manage their own custom settings.\n'
