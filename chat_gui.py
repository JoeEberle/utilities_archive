...
# Menu bar
    ...
    # Options
       ...
       # color_theme.add_command(label='Mkbhd',command=self.MKBHD)
        ...
        help_option.add_command(label="About DocBot", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("DocBot v0.1",'DocBot is a chatbot for answering python queries\nIt is based on retrieval-based NLP using pythons NLTK tool-kit module\nGUI is based on Tkinter\nIt can answer questions regarding python language for new learners')

    def about(self):
        tkinter.messagebox.showinfo("DocBot Developers","1.Joe Eberle")
